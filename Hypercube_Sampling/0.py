...
def main():
    ...
    plt.savefig("TITLE_0.png", format="png", dpi=200)
    plt.close()

    print "Title Page Built"

    os.system("convert ratio.png d.png K.png bar_plot.png +append output1.png")
    os.system("convert r.png sigma.png beta.png +append output2.png")
    os.system("convert alpha.png tau.png e.png TITLE_0.png +append output3.png")
    FILENAME = "Sensitivity_Analysis_Model_0"
    if args.RATIO:
        FILENAME += "_RATIO"
    FILENAME += ".png"

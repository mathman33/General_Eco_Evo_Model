...
\end{frame}
\begin{frame}
	\frametitle{{\normalsize Intrinsic Growth Rate as a function of the Normally Distributed Trait Value}}
	{\bf Prey Growth Rate is is a Function of the {\color{blue}Prey's Trait Value}}
	\begin{align*}
...
\begin{frame}
	...
	\begin{itemize}
		\item Prey experiences \underline{logistic growth} in absence of predator
		\item Predator experiences \underline{\underline{exponential decay}} in absence of prey
	\end{itemize}
	\begin{align*}
		Y({\color{blue}n}, {\color{blue}N}, {\color{red}m}, {\color{red}M}) &= \underline{r({\color{blue}n})\left(1 - \frac{{\color{blue}N}}{K}\right)} - {\color{red}M}a({\color{blue}n}, {\color{red}m}) \\[.1cm]
		W({\color{blue}n}, {\color{blue}N}, {\color{red}m}) &= e{\color{blue}N}a({\color{blue}n}, {\color{red}m})\ \underline{\underline{-\ d}}
	\end{align*}
	\begin{columns}
		...
		\begin{column}{0.55\textwidth}
			{\bf Parameters}
			\begin{itemize}
				\item \footnotesize\underline{$r \equiv $ Intrinsic Prey Growth Rate Function}
				\item \underline{$K \equiv $ Prey Carrying Capacity}
				\item \underline{\underline{$d \equiv $ Predator Death Rate}}
...
\begin{frame}
	...
	\begin{align*}
		\frac{dN}{dt} &= N\cdot {\color{blue}\overline{Y}(\overline{m}, \overline{n}, M, N)}= N{\color{blue}\left[\overline{r}(\overline{n})\left(1 - \frac{N}{K}\right) - M\overline{a}(\overline{n}, \overline{m})\right]}\\[.1cm]

...
\begin{frame}
	...
	\end{align*}}
	\uncover<4->{$\boxed{\text{\it Necessary Condition for Stable Exclusion:}}$}
	\begin{itemize}
		\item \uncover<4->{$d > \dfrac{Ke\alpha\tau}{\sqrt{A}}$ \hfill where $A = \sigma^2 + \beta^2 + \tau^2$.}
	\end{itemize}
	\vspace{1pt}
	\uncover<5->{{\bf Coexistence}
	\begin{align*}
		...
		\end{align*}}
	\uncover<6->{$\boxed{\text{\it Necessary Condition for Stable Coexistence:}}$}
	\begin{itemize}
		\item \uncover<6->{$\dfrac{\sigma_G^2}{\beta_G^2} > \dfrac{r}{d}\left(1 - \dfrac{d\sqrt{A}}{Ke\alpha\tau}\right)$}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	{\bf Extinction} \uncover<2->{$\boxed{\text{\it Unstable}}$}
	\begin{align*}
		({\color{blue}N^*}, {\color{red}M^*}, {\color{cyan}\overline{n}^*}, {\color{magenta}\overline{m}^*}) = (0, 0, \underline{\ \ }, \underline{\ \ })
	\end{align*}
	{\bf Exclusion} \uncover<3->{$\boxed{\text{\it Locally stable under certain conditions}}$}
	\begin{align*}
		({\color{blue}N^*}, {\color{red}M^*}, {\color{cyan}\overline{n}^*}, {\color{magenta}\overline{m}^*}) = (K, 0, \mu^*, \mu^* + \theta)\ \ \ \ \ \text{where $\mu^*$ is arbitrary}
	\end{align*}
	\uncover<4->{{\bf Necessary Conditions for Locally Stable Exclusion:}}
	\uncover<4->{{\bf Necessary Condition for Stable Exclusion:}}
	\begin{itemize}
		\item \uncover<4->{$d > \dfrac{Ke\alpha\tau}{\sqrt{A}}$ \ \ \ \ \ \ \ \ where $A = \sigma^2 + \beta^2 + \tau^2$.}
	\end{itemize}
\end{frame}
\begin{frame}
	\frametitle{Equilibria - $1\times1$}
	...
	\begin{align*}
		({\color{blue}N^*}, {\color{red}M^*}, {\color{cyan}\overline{n}^*}, {\color{magenta}\overline{m}^*}) = (\dfrac{d\sqrt{A}}{e \alpha \tau}\ ,\ \dfrac{\rho\gamma\sqrt{A}}{\alpha\tau\sqrt{B}}\left(1 - \dfrac{d\sqrt{A}}{Ke\alpha\tau}\right)\ ,\ \phi\ ,\ \theta + \phi) \\[.1cm]
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=7cm, height=5cm]{figures/1x1/variable_growth/contour_plots/tau_ratio_150417_125636.png} \\
	\end{center}
	\vspace{-10pt}
	\begin{align*}

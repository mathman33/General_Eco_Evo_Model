	...
	\begin{columns}
		\begin{column}{0.50\textwidth}
			...
			\begin{axis}[
				...
				\addplot [very thick,blue!50!black] {gauss(3, 1)};
				\draw [yshift=1.4cm, latex-latex](axis cs:3.1, 0.05) -- node [fill=white] {\Huge$\beta$} (axis cs:4, 0.05);
				\draw [yshift=0.1cm, latex-latex](axis cs:3, 0) -- node [] {} (axis cs:3, 0.38);
			\end{axis}
			\node[below] at (5.2, 0)  {\Huge{\color{blue}$\overline{n}$}}; 
			\end{tikzpicture}
		\end{column}
		\begin{column}{0.50\textwidth}
			\begin{align*}
			...
			\begin{axis}[
				...
				\draw [yshift=1.4cm, latex-latex](axis cs:3.1, 0.05) -- node [fill=white] {\Huge$\sigma$} (axis cs:4, 0.05);
				\draw [yshift=0.1cm, latex-latex](axis cs:3, 0) -- node [] {} (axis cs:3, 0.38);
			\end{axis}
			\node[below] at (5.2, 0)  {\Huge{\color{red}$\overline{m}$}}; 
			\end{tikzpicture}
		\end{column}
	\end{columns}
	\vspace{10pt}
...
\begin{frame}
	...
	\begin{itemize}
		\item \uncover<4->{$d > e\overline{a}(\overline{n}^*, \overline{m}^*)K$}

...
\keywords{Evolutionary Ecology, Eco-Evo Feedback}
...
\begin{centering}
	\begin{figure}
		...
		% \caption{\footnotesize Parameters: $e = 0.2$, $d = 1$, $\alpha = 0.05$, $\theta = 0.1$, $\tau = 0.1$, $M_0 = 100$, $\overline{m}_0 = 0$, $\sigma = 0.25$, $\sigma_G = 0.2$, $K = 225$, $\rho = 0.2$, $\gamma = 0.2$, $\phi = 0.2$, $N_0 = 120$, $\overline{n}_0 = 0.2$, $\beta = 0.25$, $\beta_G = 0.1$}
